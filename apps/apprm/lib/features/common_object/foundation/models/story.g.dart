...
class _$Story extends Story {
  ...
  factory _$Story([void Function(StoryBuilder)? updates]) =>
      (new StoryBuilder()..update(updates))._build();
  ...
  _$Story._(
      ...
      this.description})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'Story', 'id');
    BuiltValueNullFieldError.checkNotNull(createdAt, r'Story', 'createdAt');
  }
